...
def test_eff_missense_fields():
    eff = (
        "DOWNSTREAM(MODIFIER||3160||178|SAMD11|protein_coding|CODING|ENST00000420190||1),"
...
def test_eff_severity_and_stop():
    ...
    eff = (
        "NON_SYNONYMOUS_CODING(MODERATE|MISSENSE|x|Q59R|100|G|protein_coding|CODING|ENST1|2|1),"
...
def test_eff_multiallelic_allele_match():
    ...
    eff = (
        "STOP_GAINED(HIGH|NONSENSE|x|Q1*|1|G|protein_coding|CODING|ENST_A|1|1),"
